...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2021 at 08:39 AM
...
(1, '16296179782.png', '2021-08-22 07:37:27'),
(2, '16296185252.jpg', '2021-08-22 07:44:00');
...
INSERT INTO `companies` (`id`, `name`, `email`, `password`, `phone`, `state`, `country`, `address`, `description`, `availability`, `image`, `status`, `created_date`) VALUES
(1, 'Danish Test Companys', 'danishcompany@gmail.com', '40be4e59b9a2a2b5dffb918c0e86b3d7', '215723512', 2461, 162, 'test address', 'test description about the company', '1,2,3,4', '1629823948ghows-MI-201239883-e4e707ef.jpg', 1, '2021-08-24 16:52:28');

-- --------------------------------------------------------

--
-- Table structure for table `company_bookings`
--
...
--
-- Dumping data for table `company_bookings`
--

INSERT INTO `company_bookings` (`id`, `company_id`, `user_id`, `user_name`, `user_email`, `user_phone`, `package`, `time_slot`, `date`, `rated`, `status`, `created_date`) VALUES
(1, 1, 1, 'Danish Khans', 'danishkhan@gmail.com', '35345354', 3, 2, '2021-08-26', 1, 1, '2021-08-25 20:09:14');
...
(1, 'danishkhan@gmail.com', '5858ea228cc2edf88721699b2c8638e5', 'Danish Khans', 'test address', 1, 1, '2021-08-25 17:26:25');
...
INSERT INTO `packages` (`id`, `company_id`, `title`, `description`, `price`, `status`, `created_date`) VALUES
(2, 1, 'Package 1', '1) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n2) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n3) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n4) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n5) Lorem Ipsum is simply dummy text of the printing and typesetting', '100000', 1, '2021-08-25 19:10:12'),
(3, 1, 'Package 2', '1) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n\r\n2) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n\r\n3) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n\r\n4) Lorem Ipsum is simply dummy text of the printing and typesetting\r\n\r\n5) Lorem Ipsum is simply dummy text of the printing and typesetting', '200000', 1, '2021-08-25 19:14:07');
...
INSERT INTO `reviews` (`id`, `rating`, `description`, `booking_id`, `company_id`, `user_id`, `status`, `created_date`) VALUES
(1, 4, 'test description about reviews', 1, 1, 1, 1, '2021-08-30 18:40:39');
...
(1, 'danishkhan.developer@gmail.com', '564654546', '855-818-4848', '+1 206 592 2559', 'test address', '24/7', '#', '#', '#', '#', '#', '#', '2021-08-02 17:50:17');
...
INSERT INTO `time_slots` (`id`, `start_time`, `end_time`, `company_id`, `status`, `created_date`) VALUES
(2, '13:00:00', '17:00:00', 1, 1, '2021-08-25 19:37:13'),
(3, '19:00:00', '22:00:00', 1, 1, '2021-08-25 19:38:07');
...
--
-- Indexes for table `company_bookings`
--
ALTER TABLE `company_bookings`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `company_bookings`
--
ALTER TABLE `company_bookings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
